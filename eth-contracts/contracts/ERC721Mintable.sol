...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        address _tokenOwnerId = ownerOf(tokenId);
        // TODO require the given address to not be the owner of the tokenId
        require(to != _tokenOwnerId,"The given address is the owner of the tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == _tokenOwnerId || isApprovedForAll(_tokenOwnerId, msg.sender),"Caller is not authorized");

        // TODO add 'to' address to token approvals
        _tokenApprovals[tokenId] = to;
        // TODO emit Approval Event
        emit Approval(_tokenOwnerId, to, tokenId);
    }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "From address is not the owner of tokenId");
